# zen-code-action — AI Knowledge Base

**Project**: zen-code-action
**Organization**: zenlm
**Repository**: https://github.com/zenlm/zen-code-action
**HuggingFace**: https://huggingface.co/zenlm/zen-code-action
**Last Updated**: 2026-02-27

## Overview

zen-code-action is part of the Zen AI model family by Hanzo AI / Zen LM.
